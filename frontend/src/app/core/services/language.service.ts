...
const T: Record<string, Record<Lang, string>> = {
  ...
  'admin.nav.section.content':  { fr: 'Gestion contenu',   en: 'Content'              },
  'admin.nav.projects':         { fr: 'Projets',            en: 'Projects'             },
  'admin.nav.experiences':      { fr: 'Expériences',        en: 'Experiences'          },
  'admin.nav.skills':           { fr: 'Compétences',        en: 'Skills'               },
  'admin.nav.section.prefs':    { fr: 'Préférences',        en: 'Preferences'          },
  'admin.nav.theme.light':      { fr: 'Mode clair',         en: 'Light mode'           },
  'admin.nav.theme.dark':       { fr: 'Mode sombre',        en: 'Dark mode'            },
  'admin.nav.logout':           { fr: 'Déconnexion',        en: 'Logout'               },

  // ── Admin Dashboard ───────────────────────────────────────────────────────────
  'admin.dash.greeting':        { fr: 'Bonjour,',           en: 'Hello,'               },
  'admin.dash.new_project':     { fr: 'Nouveau projet',     en: 'New project'          },
  'admin.kpi.projects':         { fr: 'Projets',            en: 'Projects'             },
  'admin.kpi.active':           { fr: 'actifs',             en: 'active'               },
  'admin.kpi.articles':         { fr: 'Articles',           en: 'Articles'             },
  'admin.kpi.unread':           { fr: 'Non lus',            en: 'Unread'               },
  'admin.kpi.views':            { fr: 'Vues',               en: 'Views'                },
  'admin.kpi.views.total':      { fr: 'Totales',            en: 'Total'                },
  'admin.qa.project.label':     { fr: 'Nouveau projet',     en: 'New project'          },
  'admin.qa.project.sub':       { fr: 'Ajouter un projet',  en: 'Add a project'        },
  'admin.qa.blog.label':        { fr: 'Nouveau blog',       en: 'New post'             },
  'admin.qa.blog.sub':          { fr: 'Rédiger un article', en: 'Write an article'     },
  'admin.qa.messages.label':    { fr: 'Messages',           en: 'Messages'             },
  'admin.qa.messages.unread':   { fr: 'non lu',             en: 'unread'               },
  'admin.qa.messages.unreads':  { fr: 'non lus',            en: 'unread'               },
  'admin.qa.profile.label':     { fr: 'Mon profil',         en: 'My profile'           },
  'admin.qa.profile.sub':       { fr: 'Paramètres',         en: 'Settings'             },
  'admin.section.projects':     { fr: 'Projets actifs',     en: 'Active projects'      },
  'admin.section.messages':     { fr: 'Messages récents',   en: 'Recent messages'      },
  'admin.btn.archives':         { fr: 'Voir archives',      en: 'View archives'        },
  'admin.field.search':         { fr: 'Recherche',          en: 'Search'               },
  'admin.field.sort':           { fr: 'Tri',                en: 'Sort'                 },
  'admin.field.per_page':       { fr: 'Par page',           en: 'Per page'             },
  'admin.sort.updated_desc':    { fr: 'Maj récente',        en: 'Most recent'          },
  'admin.sort.updated_asc':     { fr: 'Maj ancienne',       en: 'Oldest'               },
  'admin.sort.title_asc':       { fr: 'Titre A-Z',          en: 'Title A-Z'            },
  'admin.sort.title_desc':      { fr: 'Titre Z-A',          en: 'Title Z-A'            },
  'admin.sort.date_desc':       { fr: 'Date récente',       en: 'Most recent'          },
  'admin.sort.date_asc':        { fr: 'Date ancienne',      en: 'Oldest'               },
  'admin.sort.name_asc':        { fr: 'Nom A-Z',            en: 'Name A-Z'             },
  'admin.sort.name_desc':       { fr: 'Nom Z-A',            en: 'Name Z-A'             },
  'admin.th.project':           { fr: 'Projet',             en: 'Project'              },
  'admin.th.description':       { fr: 'Description',        en: 'Description'          },
  'admin.th.status':            { fr: 'Statut',             en: 'Status'               },
  'admin.th.views':             { fr: 'Vues',               en: 'Views'                },
  'admin.th.actions':           { fr: 'Actions',            en: 'Actions'              },
  'admin.th.contact':           { fr: 'Contact',            en: 'Contact'              },
  'admin.th.subject':           { fr: 'Sujet',              en: 'Subject'              },
  'admin.th.date':              { fr: 'Date',               en: 'Date'                 },
  'admin.ph.project_search':    { fr: 'Titre, techno...',   en: 'Title, tech...'       },
  'admin.ph.message_search':    { fr: 'Nom, email...',      en: 'Name, email...'       },
  'admin.pagination.page':      { fr: 'Page',               en: 'Page'                 },
  'admin.empty.projects':       { fr: 'Aucun projet actif.', en: 'No active projects.' },
  'admin.empty.messages':       { fr: 'Aucun message récent.', en: 'No recent messages.' },
  'admin.loading.messages':     { fr: 'Chargement des messages...', en: 'Loading messages...' },
  'admin.msg.new':              { fr: 'Nouveau',            en: 'New'                  },
  'admin.msg.read':             { fr: 'Lu',                 en: 'Read'                 },
  'admin.msg.replied':          { fr: 'Répondu',            en: 'Replied'              },
  'admin.msg.archived':         { fr: 'Archivé',            en: 'Archived'             },
  'admin.action.mark_read':     { fr: 'Marquer lu',         en: 'Mark as read'         },
  'admin.action.reply':         { fr: 'Répondre',           en: 'Reply'                },
  'admin.action.archive_msg':   { fr: 'Archiver message',   en: 'Archive message'      },
};
